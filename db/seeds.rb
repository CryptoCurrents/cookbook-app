Recipe.create!([
  {title: "Hand Sandwich", 
     ...
     image_url: "http://occ144datkn3vrjlq7r63p19.wpengine.netdna-cdn.com/wp-content/uploads/2012/06/Hand-Sandwiches.jpeg", 
     prep_time: 1},
  {title: "Cookies", 
     chef: "Sweedish Chef",
     ingredients: "cookie mix, milk, eggs", 
     directions: "pour mix into bowl, add milk and eggs, stir well, bake", 
     image_url: "http://1.bp.blogspot.com/-w-i7-dRn_V0/TeZP9aAxPBI/AAAAAAAAAR4/8E_-JCJlEmQ/s1600/Apri2011+055pwm.jpg", 
     prep_time: 480},
  {title: "Egg", 
     chef: "Bad Josh",
     ingredients: "chicken", 
     directions: "squeeze chicken", 
     image_url: "https://boost-rankedboost.netdna-ssl.com/wp-content/uploads/2016/07/Pokemon-Go-Egg.png", 
     prep_time: 4},
  {title: "Fava Bean side dish", 
     ...
     image_url: "http://bijouxs.com/wp-content/uploads/2011/05/Favabordercropsmall.jpg", 
     prep_time: 125},
  {title: "Lasagna", 
     chef: "Josh",
     ...
     image_url: "https://m.popkey.co/1e0d43/Vo6a3.gif", 
     prep_time: 60},
  {title: "Burger", 
     chef: "Sweedish Chef",
     ...
     image_url: "http://mcdonalds.hr/content/uploads/2014/03/big-mac1.png", 
     prep_time: 5}
])